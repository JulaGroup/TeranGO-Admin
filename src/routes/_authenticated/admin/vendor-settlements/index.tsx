      ...
      <Main>
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold">Vendor Settlement Requests</h1>
              <p className="text-muted-foreground">
                Review and approve vendor payout requests. Settle manually via
                Wave.
              </p>
            </div>
            <Select
        ...
        <DialogContent>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
            <p className="text-sm text-yellow-800">
              <strong>⚠️ Important:</strong> You will need to manually pay this
