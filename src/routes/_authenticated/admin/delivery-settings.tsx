        ...
        <div className='grid gap-6 md:grid-cols-2'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Flat delivery fees for "Buy for Others" orders based on town/area
              </CardDescription>
            </CardHeader>
              ...
              <div className='space-y-2'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Input
                    ...
                    onChange={e => handleInputChange('giftZone1Fee', e.target.value)}
                    disabled={!isEditing}
                    className='w-24'
                  />
                </div>
              ...
              <div className='space-y-2'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Input
                    ...
                    onChange={e => handleInputChange('giftZone2Fee', e.target.value)}
                    disabled={!isEditing}
                    className='w-24'
                  />
                </div>
              ...
              <div className='space-y-2'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Input
                    ...
                    onChange={e => handleInputChange('giftZone3Fee', e.target.value)}
                    disabled={!isEditing}
                    className='w-24'
                  />
                </div>
              ...
              <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Input
                    ...
                    onChange={e => handleInputChange('deliveryFee0to5km', e.target.value)}
                    disabled={!isEditing}
                    className='w-24'
                  />
                </div>
              ...
              <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Input
                    ...
                    onChange={e => handleInputChange('deliveryFee5to10km', e.target.value)}
                    disabled={!isEditing}
                    className='w-24'
                  />
                </div>
              ...
              <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Input
                    ...
                    onChange={e => handleInputChange('deliveryFee10to20km', e.target.value)}
                    disabled={!isEditing}
                    className='w-24'
                  />
                </div>
              ...
              <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Input
                    ...
                    onChange={e => handleInputChange('deliveryFee20to30km', e.target.value)}
                    disabled={!isEditing}
                    className='w-24'
                  />
                </div>
              ...
              <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Input
                    ...
                    onChange={e => handleInputChange('deliveryFeeAbove30km', e.target.value)}
                    disabled={!isEditing}
                    className='w-24'
                  />
                </div>
              ...
              <div className='space-y-2'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <Input
                    ...
                    onChange={e => handleInputChange('freeDeliveryMinAmount', e.target.value)}
                    disabled={!isEditing}
                    className='w-32'
                  />
                </div>
              ...
              <div className='space-y-2'>
                ...
                <div className='flex items-center gap-2'>
                  <Input
                    ...
                    onChange={e => handleInputChange('freeDeliveryMaxKm', e.target.value)}
                    disabled={!isEditing}
                    className='w-24'
                  />
              ...
              <div className='space-y-2'>
                ...
                <div className='flex items-center gap-2'>
                  <Input
                    ...
                    onChange={e => handleInputChange('serviceFeePercent', e.target.value)}
                    disabled={!isEditing}
                    className='w-24'
                    step='0.1'
                  />
              ...
              <div className='space-y-2'>
                ...
                <div className='flex items-center gap-2'>
                  <Input
                    ...
                    onChange={e => handleInputChange('driverCommissionPercent', e.target.value)}
                    disabled={!isEditing}
                    className='w-24'
                    step='1'
                  />
          ...
          <CardContent>
            <div className='grid gap-4 md:grid-cols-3'>
              <div className='p-4 bg-muted rounded-lg'>
                <p className='text-sm text-muted-foreground'>Gift Order Zones</p>
                <p className='text-lg font-semibold'>
                  D{getValue('giftZone1Fee')} / D{getValue('giftZone2Fee')} / D{getValue('giftZone3Fee')}
                </p>
                <p className='text-xs text-muted-foreground'>Zone 1 / Zone 2 / Zone 3</p>
              </div>
              <div className='p-4 bg-muted rounded-lg'>
              ...
              <div className='p-4 bg-muted rounded-lg'>
                ...
                <p className='text-lg font-semibold'>{getValue('serviceFeePercent')}%</p>
                <p className='text-xs text-muted-foreground'>
                  Driver gets {getValue('driverCommissionPercent')}% of delivery fee
                </p>
              </div>
            </div>
          </CardContent>
